...
\end{minipage} \hfill
  \caption{Typical \SW duds. Insets indicate regions where volunteers typically
  clicked.}
  \label{fig:training-gallery:duds}
\end{figure*}
...
\end{minipage} \hfill
  \caption{Typical \SW sims. Insets indicate the location of the lens in the
  image. Users needed to click on these specific features in order to make a
