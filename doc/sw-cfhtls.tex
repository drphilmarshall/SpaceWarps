...
draw a Poisson deviate with a mean equal to the boosted average number
of sources. If the Poisson deviate is greater than zero, then 
this galaxy is flagged as a potential lensing galaxy with
Nsrc number of background sources. {\bf XXXX check if this is correct.}
