...
Preamble. Notes for future. Improvements to system to be investigated. 
...
Incompleteness, false negatives. Examples and trajectories, from stage 2
training set. Generic properties: hard to spot? Or unlucky? Costly mistakes by
expert classifiers? Or random walk? 

Impurity, false positives. Examples and trajectories, from stage 2
training set. Generic properties. Could also be solved by dynamical
stage 2? Improve training?

Solutions: dynamical stage 2, to reduce noise. Does stage 1 skill correlate
with stage 2 skill? Missing group-scale lenses at stage 2. Improve training?
