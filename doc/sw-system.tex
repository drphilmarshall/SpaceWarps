...
Euclid?  There are two approaches to detecting lenses in imaging surveys.
...
% PJM: how quickly? How much clock time per classification?
...
In \Fref{fig:training-gallery} we show 8 example training images from the
...
% \Fref{fig:crowd:timelags}, with those of the ``experienced volunteers''
% (those who classified 10 or more training subjects.) overlaid.
%
% \todo{PJM}{Make this histogram, and try and infer the typical inter-session
% lag.}
%
...
% distributions of these speeds are shown in \Fref{fig:crowd:speeddists}, in a corner
% plot that also shows the effort and skill from \Fref{fig:crowd:cornerplot}. We
% see that ...

The overall contribution rate for the \sw crowd was found,
and is plotted as a function of time in \Fref{fig:crowd:speed}. We see that
...

\todo{Phil, Chris}{Compute classification speeds, make plots, discuss. \#95}
