...
duds we selected several hundred images at random, and three of us (AM, with AM and PM) inspected them and discarded anything that could be considered a lens candidate.
...
\end{minipage} \hfill
\caption{Typical \SW ``sims.'' Insets indicate the location of the simulated
lens in each of these training
images. Users needed to click on these specific features in order to make a
correct classification.} \label{fig:training-gallery:sims}
\end{figure*}
...
\end{minipage} \hfill
\caption{Typical \SW ``duds.''  All of these subjects were correctly
classified by the community as not likely to contain gravitational lenses;
the insets merely indicate regions where $\sim10\%$ of the volunteers
clicked.} \label{fig:training-gallery:duds}
\end{figure*}
