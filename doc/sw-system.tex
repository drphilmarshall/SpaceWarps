...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure*}
\centering\includegraphics[width=0.9\linewidth]{sw-screengrab-marker+feedback.png}
...
\centering\epsfig{file=4.png,width=\linewidth,angle=0,clip=}
\end{minipage} \hfill
\begin{minipage}[b]{0.24\linewidth}
\centering\epsfig{file=5.png,width=\linewidth,angle=0,clip=}
\end{minipage} \hfill
\begin{minipage}[b]{0.24\linewidth}
\centering\epsfig{file=6.png,width=\linewidth,angle=0,clip=}
\end{minipage} \hfill
\begin{minipage}[b]{0.24\linewidth}
\centering\epsfig{file=7.png,width=\linewidth,angle=0,clip=}
\end{minipage} \hfill
...
\begin{figure*}%[!ht]
\begin{minipage}[b]{0.24\linewidth}
\centering\epsfig{file=0_ASW0009dgn.png,width=\linewidth,angle=0,clip=}
\end{minipage} \hfill
\begin{minipage}[b]{0.24\linewidth}
\centering\epsfig{file=1_ASW0009dgo.png,width=\linewidth,angle=0,clip=}
\end{minipage} \hfill
\begin{minipage}[b]{0.24\linewidth}
\centering\epsfig{file=2_ASW0009dgy.png,width=\linewidth,angle=0,clip=}
\end{minipage} \hfill
\begin{minipage}[b]{0.24\linewidth}
\centering\epsfig{file=3_ASW0009dh0.png,width=\linewidth,angle=0,clip=}
\end{minipage} \hfill
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}
\centering\includegraphics[width=0.9\linewidth]{CFHTLS_2013-10-29_10:16:35_probabilities.png}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\begin{figure}
%\centering\includegraphics[width=0.9\linewidth]{CFHTLS_2013-10-29_10:16:35_histories.png}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}
\centering\includegraphics[width=0.9\linewidth]{CFHTLS_2013-10-29_10:16:35_trajectories.png}
...
curves is somewhat less than this. The difference between them is likely to be related to issues found in other citizen science/crowdsourcing projects where, in the absence, of high quality information about classifiers, sophisticated strategies under-perform naive but simpler ones \citep{Waterhouse}. Still, a larger validation set is needed to
...
\begin{minipage}{\linewidth}
  \begin{minipage}[t]{0.47\linewidth}
    \begin{minipage}{0.46\linewidth}
      \centering\includegraphics[width=\linewidth]{ASW0008wyp_gri.png}
    \end{minipage}\hfill
    \begin{minipage}{0.50\linewidth}
      \centering\includegraphics[width=\linewidth]{ASW0008wyp_stage2_trajectory.png}
    \end{minipage}
  \end{minipage}\hfill
  \begin{minipage}[t]{0.47\linewidth}
    \begin{minipage}{0.46\linewidth}
      \centering\includegraphics[width=\linewidth]{ASW0006rkx_gri.png}
    \end{minipage}\hfill
    \begin{minipage}{0.50\linewidth}
      \centering\includegraphics[width=\linewidth]{ASW0006rkx_stage1_trajectory.png}
    \end{minipage}
  \end{minipage}
\end{minipage}
...
\begin{minipage}{\linewidth}
  \begin{minipage}[t]{0.47\linewidth}
    \begin{minipage}{0.46\linewidth}
      \centering\includegraphics[width=\linewidth]{ASW0000fgj_gri.png}
    \end{minipage}\hfill
    \begin{minipage}{0.50\linewidth}
      \centering\includegraphics[width=\linewidth]{ASW0000fgj_stage1_trajectory.png}
    \end{minipage}
  \end{minipage}\hfill
  \begin{minipage}[t]{0.47\linewidth}
    \begin{minipage}{0.46\linewidth}
      \centering\includegraphics[width=\linewidth]{ASW0003j2s_gri.png}
    \end{minipage}\hfill
    \begin{minipage}{0.50\linewidth}
      \centering\includegraphics[width=\linewidth]{ASW0003j2s_stage1_trajectory.png}
    \end{minipage}
  \end{minipage}
\end{minipage}
...
classifiers (\Sref{sec:results:crowd}).
...
on to \StageTwo skill and contribution. This figure suggests that, while the
gains are likely small (since  most of the contribution is still made by high
skill volunteers),  there could have been some benefit to opening \StageTwo on
the basis of \StageOne agent skill, in order to reduce the noise in the system
generated by new and low skill volunteers in this more difficult classification
stage.  In future, dynamically allocating subjects to volunteers according to
their agents' skill could alleviate this issue.
%A simple implementation of this would be to switch the web app to the \StageTwo
%version when either a certain \StageOne skill (and/or effort) threshold was
%passed. Good strategy would probably be to switch back to \StageOne after some
%number of \StageTwo classifications (to avoid losing the high skill users from
%\StageOne entirely), and also to make it very clear which stage the classifier
%was at (since \StageTwo requires more careful attention).
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \begin{figure}
% \centering\includegraphics[width=0.9\linewidth]{early_vs_final_skill.png}
...
\new{If, as expected, the system efficiency could indeed be improved by a factor of
...
\new{The futuristic lens-finding problem sketched in \Sref{sec:intro}, where $10^5$
...
through closer collaboration with the science team. \new{It's also possible that
...
such ``gamified'' approach would need to be taken thoughtfully.}  Reducing the
...
\Sref{sec:results:crowd} shows that effectively down-weighting new users'
