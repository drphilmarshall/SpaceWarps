...
What are the properties of the crowd? Corner plots: skill, effort, combine to
give contribution. Actual information generated. Making your own luck. How do these depend on
experience (no. of training images). Describe plot features, in stage 1.
Contrast with stage 2. \Fref{fig:crowd:cornerplot}

Who's doing all the work?
Cumulative plot of ``contributions'' (applied skill).
\Fref{fig:crowd:cumulplot}

Information, contribution totals and their interpretation. Inefficiency
measures? Super-users. 
\Tref{tab:crowd:contributions} shows contributions at stage 2 and stage 1
