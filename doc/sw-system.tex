...
\Fref{fig:interface}. The CI is the centrepiece of the \sw website,
...
further investigation of the subjects. First is the ``Quick Dashboard,'' a
...
after, if they ``favorite'' the subject. There is no ``back'' button, however:
each volunteer may only classify a given subject once.
