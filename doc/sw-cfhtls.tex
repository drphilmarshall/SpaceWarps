...
the ``known lens candidates'' sample. Note that the lens candidates in found in the other papers listed above were not included in our known lens candidate list and were not flagged to volunteers in \Talk. However, we did remove candidates in all the papers listed above when compiling the list of new lens candidates discovered in \sw described in \Sref{sec:results:newcand}.
...
The bottom panels of \Fref{fig:detmis}, show the trajectories of missed lenses for visually easier and more difficult examples in red and green, respectively.
In spite of some mild qualitative differences, both set of
