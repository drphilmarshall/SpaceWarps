...
\caption{Narrow cumulutive distributions of the contributions made by the
...
\caption{Broad cumulutive distributions of agent skill: 
...
Can we predict skill? Early skill vs final skill - some correlation,
especially in high skill users, but very broad distribution though: not
possible to predict.
\Fref{fig:crowd:skillprediction}

Stage 1 skill vs Stage 2 skill. 
Who continued to do Stage 2? Numbers. 
\Fref{fig:crowd:stage1vstage2}
