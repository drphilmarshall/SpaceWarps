...
probability
MENTION HARDER TRAINING HERE MEANING THAT THE SPREAD IS LARGER??.
...
However, identification failures (DEFINE WHAT YOU MEAN BY IDENTIFICATION FAILURES around 60\%, from inspection of a random sample)
seem to be due to the statistical noise associated with
the many short, semi-random direction kicks arising from classifications made by
low skill, inexperienced
classifiers (\Sref{sec:results:crowd}). ARE YOU SAYING THAT THERE ARE MORE OF THESE THAN THE RIGHT COLUMN EXAMPLES?  WE SHOULD GIVE NUMBERS.
...
significant number of new users who did not have enough time to acquire high
