...
\sw is a web-based system that enables the discovery of strong
...
being a lens, given the data. The data in our case are the pixel values
of a colour image. However, we can greatly compress these complex,
noisy  datasets by asking our classifiers what they think about them. A
...
image to contain a $\saidLENS$. We simplify the problem ...
