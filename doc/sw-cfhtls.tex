...
called the \sw lens sample). We find a total of 288 (and 249 new)
...
their positions and images will be available at
...
There are a total of 50 candidates with $1.3\le$G$<2$ (medium
...
identified in the literature will be available at
...
%({\bf is there someone actively looking into this whose work should be referred here ?}).
...
a subsequent \sw paper (Verma et al., prep.).
...
analysis will be presented in a subsequent \sw paper (Verma et al., in
prep.).
