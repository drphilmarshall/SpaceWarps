...
quantify the efficiency of the system. 



% From Edwin, July 1:
% 
% I've read it through and I didn't need to make any edits. The only thing I'm
% not completely convinced about is calculating inefficiency from
% "contribution". 
% 
% If the agents were perfect classifiers, and the prior for the lens class was
% set at 0.5, then it would make sense to have 1 bit contribution per subject.
% However, with imperfect classifiers and a strong prior, you need several
% labels from an agent to classify a subject confidently. I think this means you
% require more than 1 bit of "contribution" per subject. 
% 
% So, given this set of agents and your priors over the classes, you could not
% get close to 100% efficiency. However, I don't know how you could separate
% inefficiencies due to the agents from inefficiencies due to the system
% (allocating tasks, retiring subjects etc.).
% 
% Perhaps it is more correct to say that the 33% inefficiency is partly due to
% not retiring things quickly enough, but can also be due to the agents being
% imperfect classifiers, and the heavily skewed priors.
% 
...
The contribution per classification is
