...
months. This \StageOne search reduced the sample to 3381 images containing candidates; these were then
...
practice we ignore the first two classifications made by  each volunteer, for
...
decrease
in participation later on.) \StageTwo (nearly 3400 subjects) was completed in around 600
...
(Stages I and II). This FPR translates to a purity of approximately 30\%.
We find an even
