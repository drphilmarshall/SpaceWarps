...
for the lower left panel because no particular feature stood out to the citizens.
Instead, volunteers clicked many different features.}
...
correlations would necessarily lead to poorer system performance. (REPETITION OF TALK FACTOR FROM EARLIER SECTION, IT"S NOT NEEDED TWICE). There may well
