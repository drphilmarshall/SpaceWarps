...
volunteer. In stage 1, the mean effort per agent was 259; in the shorter stage
2 it was 81.
%
...
%
\item{\noindent\bf ``Skill:''} The expectation value of the information gain, $\skill$
...
quantity). In stage 1, the mean contribution per agent was 34.3 bits; in 
stage 2 it was 33.5.
%
...
classifications at low skill (although there are one or two exceptions). Most
high effort ``super-users'' have high skill. These two properties are
...
stage 1,  1.0\% of the volunteers -- 374 people -- made 90\% of the
...
making this large contribution: 9119 volunteers were ``experienced'' in that
they had all classified at least 10 training images; the 374 highest
...
783 were veterans from stage 1. However, these volunteers showed significantly
...
who retain final skill of greater than 0.05.}
...
of subjects. The ratio of this hypthetical optimum to the actual total
...
remained in the system, being over-classified. Only 3644943 classifications
...
1472.1 perfect classifiers; the stage 2 crowd was equivalent to a team of
...
of $2\times10^{-4}$, it takes 11.6 bits to make a detection; the effective
number of detections contributed by the stage 1 and stage 2 volunteers is then
1736 and 24 respectively. These figures lie roughly between the numbers of
detections and non-rejections given in column 7 of
\Tref{tab:crowd:contributions}. The uncertainty in the interpretation of the
...
\begin{tabular}{cccccccc}
  ...
  \hline 
            1    & $423683$ & $1269574.7$ & $36985$ & $1472.1$ & $10654285$ & $43 (3225)$ & $61032.7$ \\
            2    & $3679$   &   $21895.8$ &  $1964$ &  $102.4$ &   $224745$ & $91 (1391)$ &  $1641.9$ \\
  \hline \hline
\end{tabular}
\medskip\\
\end{center}
