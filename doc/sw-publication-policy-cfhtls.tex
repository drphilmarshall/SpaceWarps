...
\item \sw IV-X: Detailed results on candidates from CFHT-LS \textit{inclduing lens models, follow-up etc.} (IV: Verma et al. & authored by collaboration members)
\end{itemize}
...
% PJM: not sure if this section should be here, it was part of a conflict I 
% got when I merged... Aprajita?
% AV: It was supposed to be here, is a procedure for collaborators to suggest papers
